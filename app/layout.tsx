...
async function GitHubApiStatus() {
    ...
    return (
        <div className="dotOuter">
            {response.status === 200 ? (
                <span
                    title={`Connected to github api with ${delay}ms delay!`}
                    className="dot"
                    style={{ background: "#27a127bf" }}
                ></span>
            ) : (
                <span
                    title="Cannot connect to the github api"
                    className="dot"
                    style={{ background: "#a71e1e" }}
                ></span>
            )}
        </div>
    );
        ...
        <>
            <html lang="en">
                ...
                <body>
                    ...
                    <Footer>
                        <Link
                            href={"https://github.com/nyzd/bread-calc"}
                            target="_blank"
